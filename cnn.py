...
x_train=train_datagen.flow_from_directory(r'/users/DELL/Desktop/chest_xray/train',target_size=(64,64),batch_size=32,class_mode='binary')
x_test=test_datagen.flow_from_directory(r"/users/DELL/Desktop/chest_xray/test",target_size=(64,64),batch_size=32,class_mode='binary')
